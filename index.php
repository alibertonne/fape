...
<nav class="navbar navbar-expand-lg" id="navig">
  <div class="container">
  	<a class="navbar-brand" href="#"><img class="logo" src="images/logos/" alt="Logo" title="logo"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarTop">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" style="color: white">   Sourcing </a>
            <ul class="dropdown-menu" id="txt">
		...
		<li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" style="color: white">   Services </a>
		...
		<li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" style="color: white">   Community </a>
            <ul class="dropdown-menu">
      ...
      <ul class="navbar-nav">
        <li class="nav-item" style="color: white"><a href="#" class="nav-link" style="color: white"> Multi Request </a></li>
		<li class="nav-item" ><a href="http://bootstrap-ecommerce.com/" class="nav-link" style="color: white"> Download  </a></li>
...
<section class="header-main shadow-sm" id="navig">
	<div class="container">
...
<div class="container">
<header class="section-heading heading-line">
	<h4 class="title-section bg text-uppercase">Recommended items <i class="bi bi-eye"></i></h4>
</header>
...
<div class="col-md-2">
	<figure class="card card-product">
		...
		<figcaption class="info-wrap">
			...
			<i class="fa fa-eye" aria-hidden="true">2565</i>
			<div class="price-wrap">
...
<div class="col-md-2">
	<figure class="card card-product">
		...
		<figcaption class="info-wrap">
			...
			<i class="fa fa-eye" aria-hidden="true">5</i>
			<div class="price-wrap">
				<span class="price-new">$280</span>
			</div> <!-- price-wrap.// -->
		</figcaption>
...
<div class="col-md-2">
	<figure class="card card-product">
		...
		<figcaption class="info-wrap">
			<h6 class="title "><a href="#">The name of product</a></h6>
			<i class="fa fa-eye" aria-hidden="true">5678</i>
			<div class="price-wrap">
				<span class="price-new">$280</span>
			</div> <!-- price-wrap.// -->
		</figcaption>
...
<div class="col-md-2">
	<figure class="card card-product">
		...
		<figcaption class="info-wrap">
			...
			<h6 class="title "><a href="#">Good item name</a></h6>
				<i class="fa fa-eye" aria-hidden="true">2345</i>
			<div class="price-wrap">
				<span class="price-new">$1280</span>
				<del class="price-old">$1980</del>
			</div> <!-- price-wrap.// -->
...
<form class="row-sm form-noborder">
		...
		<div class="col-4">
		<button type="submit" class="btn btn-warning"> <i class="fa fa-envelope"></i> Subscribe </button>
		</div> <!-- col.// -->
</form>
